...
#https://github.com/nginxinc/docker-nginx/blob/97b65112180e0c7764465aa47a974fc7af3c99ae/mainline/alpine/Dockerfile
...
COPY docker/app/etc/supervisor/conf.d/php-fpm.conf /etc/supervisor/conf.d/php-fpm.conf
COPY docker/app/etc/supervisor/conf.d/nginx.conf /etc/supervisor/conf.d/nginx.conf
COPY docker/app/etc/supervisor/conf.d/laravel-worker.conf /etc/supervisor/conf.d/laravel-worker.conf
COPY docker/app/etc/supervisor/conf.d/crond.conf /etc/supervisor/conf.d/crond.conf
COPY docker/app/usr/local/etc/php-fpm.d/www.conf /usr/local/etc/php-fpm.d/www.conf
COPY docker/app/usr/local/etc/php/php.ini /usr/local/etc/php/php.ini
COPY docker/app/crontab-text /var/spool/cron/crontabs/nginx

ADD src /home/www/code

WORKDIR /home/www/code

RUN mv /tmp/vendor /home/www/code/vendor \
&&  composer dump-autoload \
&&  mkdir -p /home/www/code/storage/app/public \
...
&&  chown -R nginx:nginx /home/www/code
